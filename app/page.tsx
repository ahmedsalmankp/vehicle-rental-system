    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="pt-32 px-6 md:px-12 min-h-screen flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="max-w-xl scroll-animate">
          ...
          <p className="mt-6 text-gray-600 text-xl">
            Smart booking platform with secure rides, AI fraud detection, and
      ...
      <section className="px-6 md:px-10 py-24 bg-gray-50 text-center scroll-animate">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto mb-12">
          Getting behind the wheel has never been easier. Follow these three
          simple steps to start your rental journey right away.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="p-8 bg-white rounded-xl shadow-md hover:shadow-2xl transition-all flex flex-col items-center hover:-translate-y-2 border-t-4 border-transparent hover:border-orange-500 duration-300">
      ...
      <section className="px-6 md:px-10 py-20 bg-gray-50 text-center scroll-animate">
        <h3 className="text-3xl font-bold mb-10">Premium Collection</h3>
      ...
      <section className="text-center py-16 bg-gray-50 scroll-animate">
        <h3 className="text-3xl font-bold">Get the App</h3>
      ...
      <section className="py-16 overflow-hidden bg-white scroll-animate">
        <div className="flex gap-6 animate-scroll whitespace-nowrap">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-orange-100 border border-orange-300 px-6 py-4 rounded-xl shadow min-w-max">
              ⭐⭐⭐⭐⭐ {t}
            </div>
          ))}
        </div>
